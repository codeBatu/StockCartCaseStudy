...
public class KdvTypeCardPreviusItemButtonCommand implements Command {
	private KdvTypeCardCreateUi kdvTypeCardCreateUi;
	private KdvTypeCardRepository cardRepository;

	public KdvTypeCardPreviusItemButtonCommand(KdvTypeCardCreateUi kdvTypeCardCreateUi) {
		super();
	...
	public void execute() {
		...
		try (Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			String sql = "select * from kdvtypetbl  where KdvTypeId = (select Max(KdvTypeId) from kdvtypetbl where KdvTypeId <"
