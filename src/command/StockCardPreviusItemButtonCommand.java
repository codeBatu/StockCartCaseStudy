...
public class StockCardPreviusItemButtonCommand implements Command {

	private StockCardView cardView;
	private StockCardRepository cardRepository;

	public StockCardPreviusItemButtonCommand(StockCardView stockCardView) {
		super();
	...
	public void execute() {
		try (Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			String sql = "select * from stockcardtbl  where stock_code = (select MAX(stock_code) from stockcardtbl where stock_code <"
