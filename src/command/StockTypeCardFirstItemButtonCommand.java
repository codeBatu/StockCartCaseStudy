...
public class StockTypeCardFirstItemButtonCommand implements Command {
	private StockTypeCardCreateUi cardCreateUi;

	public StockTypeCardFirstItemButtonCommand(StockTypeCardCreateUi cardCreateUi) {
	...
	public void execute() {
		try (Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			Query query = session.createNativeQuery(Constant.GET_FIRST_ITEM_FROM_STOCK_TYPE_TABLE);
